...
let takeoverState: Record<string, boolean> = {
  claude: false,
  codex: false,
  gemini: false,
};
...
export const getTakeoverStatus = () => deepClone(takeoverState) as Record<string, boolean>;

export const setTakeoverStatusForApp = (appType: string, enabled: boolean) => {
  takeoverState[appType] = enabled;
};
