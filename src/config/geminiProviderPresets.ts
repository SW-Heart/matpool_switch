...
export const geminiProviderPresets: GeminiProviderPreset[] = [
  {
    ...
    settingsConfig: {
      env: {
        GOOGLE_GEMINI_BASE_URL: MATPOOL_GATEWAY.gemini,
        GEMINI_MODEL: MATPOOL_DEFAULT_MODELS.gemini,
      },
    },
    baseURL: MATPOOL_GATEWAY.gemini,
    model: MATPOOL_DEFAULT_MODELS.gemini,
    description: MATPOOL_BRAND.description,
    category: "aggregator",
    theme: {
      icon: "generic",
