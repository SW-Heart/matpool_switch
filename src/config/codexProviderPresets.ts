...
export const codexProviderPresets: CodexProviderPreset[] = [
  {
    ...
    config: generateThirdPartyConfig(
      MATPOOL_BRAND.name.toLowerCase(),
      MATPOOL_GATEWAY.openai,
      MATPOOL_DEFAULT_MODELS.openai,
    ),
    modelCatalog: modelCatalog([
      {
        model: MATPOOL_DEFAULT_MODELS.openai,
        displayName: "GPT-5.5",
...
requires_openai_auth = true`,
  ...
  },
  {
    ...
    apiKeyUrl: "https://platform.moonshot.cn/console/api-keys?aff=matpool-switch",
    auth: generateThirdPartyAuth(""),
    config: generateThirdPartyConfig(
      "kimi",
