...
import appIcon from "@/assets/icons/matpool-logo.svg";
      ...
      >
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3 flex-wrap">
            <img src={appIcon} alt="Matpool Switch" className="h-5 w-5" />
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              variant="outline"
              size="sm"
              onClick={() => settingsApi.openExternal("https://matpool.com")}
