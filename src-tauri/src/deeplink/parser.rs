...
//!
//! Parses matpool:// URLs into DeepLinkImportRequest structures.
...
/// Parse a matpool:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// matpool://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "matpool" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'matpool', got '{scheme}'"
        )));
    }
