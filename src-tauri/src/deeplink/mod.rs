//! Deep link import functionality for Matpool Switch
//!
//! This module implements the matpoolswitch:// protocol for importing configurations
...
pub use utils::redact_deeplink_url_for_log;

/// Deep link import request model
///
/// Represents a parsed matpoolswitch:// URL ready for processing.
